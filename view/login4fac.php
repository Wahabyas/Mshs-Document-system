...
<body>
    ...
    $('form[name="login_form"]').on('submit', function (e) {
        ...
        if (u_username === '' && p_password === '') {
			...
			setTimeout(' window.location.href = "login4fac.php"; ', 1000);
        }
            ...
            $.ajax({
                type: 'POST',
                url: 'controllers/login_process4fac.php',
                data: {
                    username: u_username,
                    password: p_password
                },
            ...
            .done(function (t) {
                if (t == 0) {
                    ...
                    $('#alert-msg').html('<div class="alert alert-success">Welcome Faculty</div>');
