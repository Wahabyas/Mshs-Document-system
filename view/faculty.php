       ...
       include ('includes/sidebar.php'); ?>
        <div class="main-panel">
            ...
            <?php include ('includes/header.php') ?>
                ...
                $user = $conn->fetch_faculty();
                }elseif($userinfo['role']== 'Chairperson' && $userinfo['Strand']== 'TVL'){
        
                $user = $conn->fetch_facultyalone1();
                }else{
                    $user = $conn->fetch_facultyalone($Strand);
                }
                       ?>
            <!-- End Navbar -->
            <div class="content">
    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" id="search-folder" class="form-control" placeholder="Search Faculty...">
                ...
                <i class="nc-icon nc-zoom-split" style="font-size: 40px;"></i>
                        ...
                        <div class="card strpied-tabled-with-hover">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover fac">
                                        <thead>
                                            <th>No.</th>
                                            <th>Fullname</th>
                                            <th>role</th>
...
<script>
    $(document).ready(function() {
        $('#search-folder').on('keyup', function() {
            ...
            $('table.fac tbody tr').filter(function() {
