            ...
            <?php include ('includes/header.php') ?>
                ...
                $conn =  new class_model();
                 ...
                 if($userinfo['role'] == 'Admin'){
                    $user = $conn->fetch_staff();
                 }elseif($userinfo['role']== 'Chairperson' && $userinfo['Strand']== 'TVL'){
         
                 $user = $conn->fetch_staffalone1();
                 }else{
                    $user = $conn->fetch_staffalone($Strand);
                 }
    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" id="search-folder" class="form-control" placeholder="Search Staff...">
                ...
                <i class="nc-icon nc-zoom-split" style="font-size: 40px;"></i>
                            ...
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Information of Users</p>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover staff">
                                        <thead>
                                            <th>No.</th>
                                            <th>Fullname</th>
                                            <th>role</th>
...
<?php }else{} ?>
                                                <?php if($_SESSION['user_id'] == $row['user_id'] ||$userinfo['role'] == 'Admin' || $userinfo['role'] == 'Chairperson' ){ ?>
                                                ...
                                                <i  class="nc-icon nc-settings-gear-64  " style="font-size: 20px;"></i>
                                                  </a>
