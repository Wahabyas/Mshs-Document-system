...
<body>
    ...
    $('form[name="login_form"]').on('submit', function (e) {
		...
		setTimeout(' window.location.href = "login4chair.php"; ', 1000);
        }
        ...
        // Check if only the username is empty
            ...
            // If both fields are non-empty, proceed with AJAX request
            $.ajax({
                type: 'POST',
                url: 'controllers/login_process4chair.php',
                data: {
                    username: u_username,
                    password: p_password
                },
            ...
            .done(function (t) {
                if (t == 0) {
                    ...
                    $('#alert-msg').html('<div class="alert alert-success">Welcome Chairperson</div>');
